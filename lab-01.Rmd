...
The NA means not available, there is data that cant be calculated into an average and thus the function would not know what to calculate.
...
na.rm would get rid of the NAs for the calculation allowing us to get an average whilst ignoring the NA inputs
...
The data is skewed right, there are a few locations with a lot more visitors than others
